...
export interface ApiAttractionAttraction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    approximateCost: Schema.Attribute.Integer;
    category: Schema.Attribute.Enumeration<
      ['sightseeing', 'food', 'nature', 'adventure', 'culture', 'shopping']
    > &
      Schema.Attribute.DefaultTo<'sightseeing'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attractions: Schema.Attribute.Relation<
      ...
      'api::attraction.attraction'
    >;
    averageDailyBudget: Schema.Attribute.Integer;
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    image: Schema.Attribute.Media<'images'>;
    isBudgetFriendly: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    latitude: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    averagePricePerPerson: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    longitude: Schema.Attribute.Decimal;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    priceLevel: Schema.Attribute.Enumeration<['budget', 'midrange', 'luxury']> &
      Schema.Attribute.DefaultTo<'midrange'>;
    publishedAt: Schema.Attribute.DateTime;
    shortDescription: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
